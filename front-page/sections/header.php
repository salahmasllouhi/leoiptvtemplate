...
if (empty($site_slug)) {
    ...
    if (in_array($first_segment, array('sv', 'no', 'dk', 'fi', 'is', 'de'))) {
        ...
        <div class="nav-right">
            <div class="country-selector" id="countrySelector">
                ...
                <div class="country-dropdown" id="countryDropdown">
                    <div class="country-option" data-currency="usd" data-lang="en" data-symbol="$" data-flag="🇺🇸">
                        <span class="country-flag">🇺🇸</span><span>English</span>
                    </div>
                    <div class="country-option" data-currency="sek" data-lang="sv" data-symbol="kr" data-flag="🇸🇪">
                        <span class="country-flag">🇸🇪</span><span>Svenska</span>
                    </div>
                    <div class="country-option" data-currency="nok" data-lang="no" data-symbol="kr" data-flag="🇳🇴">
                        <span class="country-flag">🇳🇴</span><span>Norsk</span>
                    </div>
                    <div class="country-option" data-currency="dkk" data-lang="dk" data-symbol="kr" data-flag="🇩🇰">
                        <span class="country-flag">🇩🇰</span><span>Dansk</span>
                    </div>
                    <div class="country-option" data-currency="eur" data-lang="fi" data-symbol="€" data-flag="🇫🇮">
                        <span class="country-flag">🇫🇮</span><span>Suomi</span>
                    </div>
                    <div class="country-option" data-currency="isk" data-lang="is" data-symbol="kr" data-flag="🇮🇸">
                        <span class="country-flag">🇮🇸</span><span>Íslenska</span>
                    </div>
                    <div class="country-option" data-currency="eur" data-lang="de" data-symbol="€" data-flag="🇩🇪">
                        <span class="country-flag">🇩🇪</span><span>Deutsch</span>
                    </div>
                </div>
            </div>
...
<div class="mobile-menu" id="mobile-menu">
    ...
    <div class="mobile-language-selector">
        ...
        <div class="mobile-language-options">
            <button class="mobile-lang-btn" data-currency="usd" data-lang="en" onclick="redirectToRegion('en')">🇺🇸 English</button>
            <button class="mobile-lang-btn" data-currency="sek" data-lang="sv" onclick="redirectToRegion('sv')">🇸🇪 Svenska</button>
            <button class="mobile-lang-btn" data-currency="nok" data-lang="no" onclick="redirectToRegion('no')">🇳🇴 Norsk</button>
            <button class="mobile-lang-btn" data-currency="dkk" data-lang="dk" onclick="redirectToRegion('dk')">🇩🇰 Dansk</button>
            <button class="mobile-lang-btn" data-currency="eur" data-lang="fi" onclick="redirectToRegion('fi')">🇫🇮 Suomi</button>
            <button class="mobile-lang-btn" data-currency="isk" data-lang="is" onclick="redirectToRegion('is')">🇮🇸 Íslenska</button>
            <button class="mobile-lang-btn" data-currency="eur" data-lang="de" onclick="redirectToRegion('de')">🇩🇪 Deutsch</button>
        </div>
    </div>
